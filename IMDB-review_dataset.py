...
'''
model=models.Sequential()
model.add(layers.Dense(16, kernel_regularizer=regularizers.L1(l1=0.001), #!weight regularization
                       activation='relu',input_shape=(10000,)))
model.add(layers.Dense(16, kernel_regularizer=regularizers.L1(l1=0.001),
                       activation='relu'))
model.add(layers.Dense(1,activation='sigmoid'))
'''
model=models.Sequential()
model.add(layers.Dense(16, activation='relu', input_shape=(10000,)))
model.add(layers.Dropout(0.5)) #! Ajout de Dropout à 50%
model.add(layers.Dense(16, activation='relu'))
