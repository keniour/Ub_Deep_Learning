...
#3.6.4 K-fold validation :
    """Pour ajuster les parametres du modèles quand on a peut de paramètres 
...
for i in range(k):
    ...
    partial_train_data = np.concatenate( #prepares the training data from all other partitions 
